...
export const GetCaseDigestOutputSchema = z.object({
  ...
  searchExhausted: z.boolean().optional().describe("If true, all available data has been retrieved. Stop retrying this case if data like parties is empty."),
  noResultsReason: z.string().nullable().optional().describe("If set to 'access_restricted', the court restricts information and missing fields cannot be obtained elsewhere."),
